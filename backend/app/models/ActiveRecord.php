...
class ActiveRecord
{
    ...
    public function crear()
    {
        ...
        // Convertir los campos con formato JSON de nuevo a JSON si se trata de la tabla solicitudes
        if (isset($atributos['relaciones_oficiales_meses']) && is_array($atributos['relaciones_oficiales_meses'])) {
            $atributos['relaciones_oficiales_meses'] = json_encode($atributos['relaciones_oficiales_meses']);
        }

        if (isset($atributos['oficiales_ids']) && is_array($atributos['oficiales_ids'])) {
            $atributos['oficiales_ids'] = json_encode($atributos['oficiales_ids']);
        }
